...
2. Clients visit `/book`, pick an open slot, their length + design tier, and submit their info.
...
Real Tier 1 and Tier 4 examples are already in `public/images/gallery/` and shown on the
Services page. To add Tier 2 and Tier 3 examples (or a hero photo), drop files into
`public/images/`, then reference them with Next's `<Image src="/images/your-file.jpg" ... />`
component — see `app/services/page.js` for an example of how the gallery is wired up.
