      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-5xl px-6 pt-20 pb-16 sm:pt-28 sm:pb-24">
            <p className="text-xs uppercase tracking-[0.2em] text-umber mb-4">
        ...
        <section className="border-y border-line/70 bg-stoneDeep/60">
          <div className="mx-auto max-w-5xl px-6 py-14">
            <p className="text-xs uppercase tracking-[0.2em] text-ink/50 mb-2">Design tiers</p>
        ...
        <section className="mx-auto max-w-5xl px-6 py-16 grid gap-10 sm:grid-cols-4">
          <div>
            ...
            <p className="text-sm text-ink/70">No walk-ins. All bookings go through the site.</p>
          </div>
          <div>
            <p className="font-display text-lg text-inkDeep mb-1">Monthly slots</p>
            <p className="text-sm text-ink/70">
              New availability is posted each month — check back or follow @natwnails.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm text-ink/70">{LOYALTY_NOTE}</p>
          </div>
        </section>
      </main>
