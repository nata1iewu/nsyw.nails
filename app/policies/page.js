  ...
  return (
    <>
      ...
      <main className="relative mx-auto max-w-3xl px-6 pt-16 pb-24 overflow-hidden">
        ...
        <p className="text-xs uppercase tracking-[0.2em] text-umber mb-3">Before you book</p>
        ...
        <section className="mb-10">
          ...
          <p className="mt-3 text-sm text-ink/60 pl-4 border-l border-line">
        ...
        <section className="mb-10">
          <p className="text-ink/80 leading-relaxed">
            ...
            removals</span>, so please try to have your previous set removed before coming
            (unless I did your previous set).
          </p>
        </section>
